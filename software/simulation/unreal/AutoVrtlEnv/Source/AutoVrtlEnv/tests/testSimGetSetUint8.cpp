...
void AtestSimGetSetUint8::Sim3dStep(float DeltaSeconds) {
    unsigned int  numElements = 65536;
...
void AtestSimGetSetUint8::Sim3dRelease() {
    Super::Sim3dRelease();
    if (SignalReader) {
